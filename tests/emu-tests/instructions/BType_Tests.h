...
class BTypeInstructionTests : public CxxTest::TestSuite
{
  ...
  void testCreateFromNothing(void) {
    TS_ASSERT_THROWS_NOTHING(BTypeInstruction b = BTypeInstruction(4));
  }

  void testCreateFromArgs(void) {
    BTypeInstruction b = BTypeInstruction(4, 127, 1, 15, 7, 31, 31, 63, 1);
  ...
  void testDecode(void) {
    ...
    BTypeInstruction b = BTypeInstruction(4);
  ...
  void testCreateWithLargeOpcode(void) {
    TS_ASSERT_THROWS(BTypeInstruction b = BTypeInstruction(4, 128, 0, 0, 0, 0, 0, 0, 0), InstructionException*);
  }

  void testCreateWithLargeImm1(void) {
    TS_ASSERT_THROWS(BTypeInstruction b = BTypeInstruction(4, 0, 2, 0, 0, 0, 0, 0, 0), InstructionException*);
  }

  void testCreateWithLargeImm4(void) {
    TS_ASSERT_THROWS(BTypeInstruction b = BTypeInstruction(4, 0, 0, 16, 0, 0, 0, 0, 0), InstructionException*);
  }

  void testCreateWithLargeFunc3(void) {
    TS_ASSERT_THROWS(BTypeInstruction b = BTypeInstruction(4, 0, 0, 0, 8, 0, 0, 0, 0), InstructionException*);
  }

  void testCreateWithLargeRS1(void) {
    TS_ASSERT_THROWS(BTypeInstruction b = BTypeInstruction(4, 0, 0, 0, 0, 32, 0, 0, 0), InstructionException*);
  }

  void testCreateWithLargeRS2(void) {
    TS_ASSERT_THROWS(BTypeInstruction b = BTypeInstruction(4, 0, 0, 0, 0, 0, 32, 0, 0), InstructionException*);
  }

  void testCreateWithLargeImm6(void) {
    TS_ASSERT_THROWS(BTypeInstruction b = BTypeInstruction(4, 0, 0, 0, 0, 0, 0, 64, 0), InstructionException*);
  }

  void testCreateWithLargeImm31(void) {
    TS_ASSERT_THROWS(BTypeInstruction b = BTypeInstruction(4, 0, 0, 0, 0, 0, 0, 0, 2), InstructionException*);
  }
  ...
  void testGetImmWrongPosition(void) {
    BTypeInstruction b = BTypeInstruction(4, 0, 0, 0, 0, 0, 0, 0, 0);
